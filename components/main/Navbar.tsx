...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between rounded-xl m-2 p-3 sm:m-4 sm:p-4
      text-xs sm:text-base md:text-lg dir-rtl whitespace-nowrap border-b border-border-main bg-card-bg/60">
      {/* لوگو / برند */}
