...
export default function SpecialProducts() {
  ...
  if (loading) return <p className="p-4 text-center text-(--color-muted-text)">در حال دریافت اطلاعات...</p>;

  return (
    <div className="dir-rtl my-8 ">
      <div className="flex flex-row p-4 gap-3 items-center">
        <h2 className="text-2xl font-extrabold text-(--color-text-main)">پیشنهادهای شگفت‌انگیز</h2>
        <video
          src="/icons/Fire.webm"
          width={28}
          height={28}
